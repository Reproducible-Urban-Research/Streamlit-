...
# Streamlit title 
st.markdown("<h1 style='text-align: center;'>Historical Population Growth London (1801–2021)</h1>", unsafe_allow_html=True)
# or use this title  - st.title("Historical Population Growth London (1801–2021)")
